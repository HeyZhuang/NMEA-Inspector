...
#include <memory>
#include "../../../../../../../../code-beidou/serialmanager.h"
...
QT_MOC_LITERAL(4, 33, 17), // "portStatusChanged"
QT_MOC_LITERAL(5, 51, 6), // "isOpen"
QT_MOC_LITERAL(6, 58, 13), // "errorOccurred"
QT_MOC_LITERAL(7, 72, 5), // "error"
QT_MOC_LITERAL(8, 78, 14), // "onDataReceived"
QT_MOC_LITERAL(9, 93, 15), // "onErrorOccurred"
QT_MOC_LITERAL(10, 109, 28) // "QSerialPort::SerialPortError"

    },
    "SerialManager\0dataReceived\0\0data\0"
    "portStatusChanged\0isOpen\0errorOccurred\0"
    "error\0onDataReceived\0onErrorOccurred\0"
...
void SerialManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->portStatusChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialManager::portStatusChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void SerialManager::portStatusChanged(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
